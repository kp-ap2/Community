					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								...
								<ul class="submenu">
									<li class="">
										<a href="<?php echo base_url('admin/TOD_Reg') ?>">
											Applicant
										</a>
									</li>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                              <input type="text" name="id" id="id" class="form-control" placeholder="Product Code">
                            </div>
                        </div>
                        <div class="form-group row">
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							...
							Community Angkasa Pura II &copy; 2019
						</span>
            ...
            $(document).ready(function(){
                            ...
                            for(i=0; i<data.length; i++){
                                html += '<tr>'+
                                        ...
                                        '<td style="text-align:right;">'+
                                            '<a href="javascript:void(0);" class="btn btn-info btn-sm item_edit" data-id="'+data[i].id+'" data-product_name="'+data[i].product_name+'" data-price="'+data[i].product_price+'">Edit</a>'+' '+
                ...
                $('#btn_save').on('click',function(){
                    ...
                    $.ajax({
                        ...
                        dataType : "JSON",
                        data : {id:id , product_name:product_name, price:price},
                        success: function(data){
                            $('[name="id"]').val("");
